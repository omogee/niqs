...
class UnitRateForm extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            state:"",
...
formData.append("file",this.state.csv);
        axios.post(`https://niqsdatabank.herokuapp.com/api/v1/unitrate/import`,formData,config)
        .then(res => {
 ...
 this.setState({state:"",description:"",measurement:"",unit:"",month:"",year:"",price:"",sub_category:"",category:""})
    ...
    render() { 
        console.log(this.state.csv, "csv")
            ...
            return ( 
                <div className="container">
                     ...
                     <h2 className="text-primary">Unit Rate</h2>
                     </div>               
                     </div>
                    <div className="row">
